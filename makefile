objects = util.o errormsg.o lex.yy.o y.tab.o absyn.o parse.o table.o \
		  symbol.o escape.o types.o env.o temp.o frame.o tree.o \
		  translate.o semant.o prabsyn.o printtree.o main.o 

a.out: $(objects)
	cc -g $(objects)

main.o: main.c errormsg.h util.h absyn.h parse.h prabsyn.h escape.h
	cc -g -c main.c
...
frame.o: frame.c frame.h util.h temp.h
	cc -g -c frame.c
